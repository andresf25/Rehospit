...
<h3 style="text-align: center;" id="Generalidades" markdown="1">Generalidades</h3>
...
<a href="#Inicio">Volver al inicio</a></li></div>
...
<li>La mayoría de los pacientes no estuvieron ingresados en el UCI
...
<p style="text-align: justify;">Vemos que la representacion para la categoría positiva es un poco mas del 2% de la información. En este caso vamos a realizar un tratamiento que permita aumentar la clase minoritaria, sin utilizar soluciones genéricas como reducir la clase mayoritaria al nivel de la clase menor.</p>

<p style="text-align: justify;">Para ello, vamos a utilizar la técnica SMOTE (Synthetic Minority Oversampling Method), la cual genera nuevas instancias artificiales de la clase más pequeña interpolando los valores de las instancias minoritarias más cercanas a una dada.</p>
...
<h3 style="text-align: center;"><a id="ajustemod">Ajuste del modelo y Estimación de parámetros</a></h3>
...
2. Cuando a un paciente se le realiza un procedimiento quirúrgico su probabilidad de que termine hospitalizado de nuevo por el mismo diagnóstico, disminuye en 0.14 en comparación a cuando no se le realiza ninguna cirugía.
...
<h3 style="text-align: center;"><a id="Evaluacion">Prediciendo y evaluando el desempeño del modelo</a></h3>
