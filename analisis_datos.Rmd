...
ggplot(
  ...
  aes(x=rehosp_oms1, 
      ...
      shape=as.factor(rehosp_oms1))) +
  geom_boxplot() + 
  labs(title="Toatl dias hospitalizado",
       x="", 
       y = "Dias hospitalización")  + 
  theme_minimal() + 
  theme(plot.title = element_text(hjust = 0.5),legend.position = "none") + 
  scale_colour_brewer( palette="Paired") -> p3
...
ggplot(
  ...
  theme_minimal() + 
  theme(plot.title = element_text(hjust = 0.5),legend.position = "none") + 
  scale_colour_brewer( palette="Paired") -> p4
...
ggplot(data_rehosp_s, aes(x = edad)) +
  ...
  labs(x = "Edad", 
       y = "Frecuencia", 
       fill = "Rehospitalización") +
  ggtitle("Distribución Edad Grupo") +
...
ggplot(data_rehosp_s, aes(x = ingreso)) +
  ...
  labs(x = "Ingreso", 
       y = "Frecuencia", 
       fill = "Rehospitalización") +
  ggtitle("Distribución Ingreso") +
  theme(plot.title = element_text(hjust = 0.5)) + scale_fill_brewer(palette = "Paired") + theme(axis.text.x = element_text(angle = 90))
...
ggplot(data_rehosp_s, aes(x = est_civil)) +
  ...
  labs(x = "Estado civil", 
       y = "Frecuencia", 
       fill = "Rehospitalización") +
  ggtitle("Distribución Estado civil") +
  theme(plot.title = element_text(hjust = 0.5)) + scale_fill_brewer(palette = "Paired")
...
ggplot(data_rehosp_s, aes(x = quirur1)) +
  geom_bar(aes(fill = as.factor(rehosp_oms1)),
           na.rm = TRUE) +
  theme_minimal() +
  labs(x = "Proc Quirurgico", 
       y = "Frecuencia", 
       fill = "Rehospitalización") +
  ggtitle("Distribución Proc Quirurgico") +
  theme(plot.title = element_text(hjust = 0.5)) + scale_fill_brewer(palette = "Paired")
...
ggplot(data_rehosp_s, aes(x = quirur2)) +
  geom_bar(aes(fill = as.factor(rehosp_oms1)),
           na.rm = TRUE) +
  theme_minimal() +
  labs(x = "Proc Quirurgico rehosp", 
       y = "Frecuencia", 
       fill = "Rehospitalización") +
  ggtitle("Distribución Proc Quirurgico rehosp") +
  theme(plot.title = element_text(hjust = 0.5)) + scale_fill_brewer(palette = "Paired")
```
