...
ggplot(data_rehosp_s, aes(x = ciudad)) +
  geom_bar(aes(fill = rehosp_oms1),
           na.rm = TRUE) +
  theme_minimal() +
  labs(x = "Ciudad", 
       y = "Frecuencia", 
       fill = "Rehospitalización") +
  ggtitle("Distribución Ciudad") +
  theme(plot.title = element_text(hjust = 0.5)) + scale_fill_brewer(palette = "Paired")+ theme(axis.text.x = element_text(angle = 90, size = 5))
