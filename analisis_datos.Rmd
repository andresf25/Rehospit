...
list.of.packages <- c("readxl", "dplyr", "ggplot2", "ggcorrplot", "VIM", "RColorBrewer", "Information", "knitr", "kableExtra", "gridExtra", "skimr", "nortest", "GGally", "plotly", "lattice", "DMwR", "caTools", "plotly", "pROC", "caret", "rpart", "randomForest", "e1071", "purrr")
...
El archivo contiene registros que corresponden a eventos de rehospitalizaciones y se encuentra detallado a nivel de cada evento hospitalario. En total son 34746 registros, 18 variables, descartando de manera inicial, aquellos atributos que se derivan después del segundo diagnóstico; los datos se describen a continuación:
...
<li>El pago hospitalario promedio fue de $5'705,090 con una desviación de $11'443,485 de la media, lo que indica una gran dispersión en los datos, y posible presencia de outliers.
<ul>
