...
```{r}
data_rehosp %>%
  mutate(pago_hosp = ifelse(quirur == "Si", outlier(mydata = filter(data_rehosp, quirur == "Si"), 
                                                    value = "pago_hosp", 
                                                    q_min = 0.99, q_max = 0), pago_hosp),
         pago_hosp = ifelse(quirur == "No", outlier(mydata = filter(data_rehosp, quirur == "No"), 
                                                    value = "pago_hosp", 
                                                    q_min = 0.99, q_max = 0), pago_hosp),
