...
p1 <- myboxplot(data_rehosp, data_rehosp$rehosp_oms, data_rehosp$marcas, "", "Rehospitalización", "Marcas", "Rehospitalización")

p2 <- myboxplot(data_rehosp, data_rehosp$rehosp_oms, data_rehosp$pago_hosp, "", "Rehospitalización", "Pago Diag", "")
...
p5 <- myboxplot(data_rehosp, data_rehosp$rehosp_oms, data_rehosp$dias_hosp, "Total dias hospitalizado", "", "Dias hospitalización", "")

p6 <- myboxplot(data_rehosp, data_rehosp$rehosp_oms, data_rehosp$dias_uci, "Total días UCI", "", "Dias UCI", "")

p7 <- myboxplot(data_rehosp, data_rehosp$rehosp_oms, data_rehosp$dias_uce, "Total días UCE", "", "Dias UCE", "")
...
p9 <- mygeom_bar(data_rehosp, data_rehosp$edad, data_rehosp$rehosp_oms, "Edad", "", "Frecuencia", "Rehospitalización", NULL)

p10 <- mygeom_bar(data_rehosp, data_rehosp$estrato, data_rehosp$rehosp_oms, "Estrato", "", "Frecuencia", "Rehospitalización", NULL)

p11 <- mygeom_bar(data_rehosp, data_rehosp$genero, data_rehosp$rehosp_oms, "Género", "", "Frecuencia", "Rehospitalización", NULL)
...
p12 <- mygeom_bar(data_rehosp, data_rehosp$ingreso, data_rehosp$rehosp_oms, "Ingreso", "", "Frecuencia","Rehospitalización", 90)
p12
p14 <- mygeom_bar(data_rehosp, data_rehosp$quirur, data_rehosp$rehosp_oms, "Proc quirúrgico", "", "Frecuencia", "Rehospitalización", NULL)
p14
...
p15 <- mygeom_bar(data_rehosp, data_rehosp$ramo, data_rehosp$rehosp_oms, "Ramo Seguro", "", "Frecuencia", "Rehospitalización", NULL)

p16 <- mygeom_bar(data_rehosp, data_rehosp$est_civil, data_rehosp$rehosp_oms, "Estado civil", "", "Frecuencia", "Rehospitalización", NULL)
