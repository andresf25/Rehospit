...
data_rehosp_s %>%
  ...
  rename(edad = Edad_Hospitalizacion, 
         ...
         rehosp_oms = rehosp_cat_oms) -> data_rehosp_s
head(data_rehosp_s)
```
...
* <b>dias_hosp:</b> Dias de hospitalizacion
* <b>dias_uci:</b> Numero dias en uci
* <b>dias_uce:</b> Numero dias en uce
* <b>pago_hosp:</b> Valor pagado primera hospitalizacion
...
* <b>diagnos:</b> Codigo Diagnostico cie10 de la atencion
* <b>categoria:</b>
* <b>quirur:</b> Si tuvo algun tipo de servicio relacionado a procedimiento quirurgico
* <b>rehosp_cat_oms: Similitud categoria cie10, la cual es nuestra variable objetivo</b>

Fecha (1):

* <b>Fecha_Ingreso:</b> Fecha ingreso hospitalización 

Generamos la estadistica descriptiva de los datos; en ella se puede visualizar que es necesario realizar algunas conversiones en los tipos de datos que vienen por defecto (por ejemplo el estrato aparece como una variable numérica).
...
data_rehosp_s %>%
  ...
  select(-diagnos, -categoria) -> data_rehosp_s2
...
p1 <- myboxplot(data_rehosp_s, data_rehosp_s$rehosp_oms, data_rehosp_s$marcas, "", "Rehospitalización", "Marcas", "Rehospitalización")

p2 <- myboxplot(data_rehosp_s, data_rehosp_s$rehosp_oms, data_rehosp_s$pago_hosp, "", "Rehospitalización", "Pago Diag", "")
...
p5 <- myboxplot(data_rehosp_s, data_rehosp_s$rehosp_oms, data_rehosp_s$dias_hosp, "Total dias hospitalizado", "", "Dias hospitalización", "")

p6 <- myboxplot(data_rehosp_s, data_rehosp_s$rehosp_oms, data_rehosp_s$dias_uci, "Total días UCI", "", "Dias UCI", "")

p7 <- myboxplot(data_rehosp_s, data_rehosp_s$rehosp_oms, data_rehosp_s$dias_uce, "Total días UCE", "", "Dias UCE", "")
...
p9 <- mygeom_bar(data_rehosp_s, data_rehosp_s$edad, data_rehosp_s$rehosp_oms, "Edad", "", "Frecuencia", "Rehospitalización", NULL)

p10 <- mygeom_bar(data_rehosp_s, data_rehosp_s$estrato, data_rehosp_s$rehosp_oms, "Estrato", "", "Frecuencia", "Rehospitalización", NULL)

p11 <- mygeom_bar(data_rehosp_s, data_rehosp_s$genero, data_rehosp_s$rehosp_oms, "Género", "", "Frecuencia", "Rehospitalización", NULL)
...
p12 <- mygeom_bar(data_rehosp_s, data_rehosp_s$ingreso, data_rehosp_s$rehosp_oms, "Ingreso", "", "Frecuencia","Rehospitalización", 90)

p14 <- mygeom_bar(data_rehosp_s, data_rehosp_s$quirur1, data_rehosp_s$rehosp_oms, "Proc quirúrgico", "", "Frecuencia", "Rehospitalización", NULL)
...
p15 <- mygeom_bar(data_rehosp_s, data_rehosp_s$ramo, data_rehosp_s$rehosp_oms, "Ramo Seguro", "", "Frecuencia", "Rehospitalización")

p16 <- mygeom_bar(data_rehosp_s, data_rehosp_s$est_civil, data_rehosp_s$rehosp_oms, "Estado civil", "", "Frecuencia", "Rehospitalización")
